...
const UpdateItem = ({setShowUpdate, item}) => {
    const [id, setId] = useState(item.id)
    const [name, setName] = useState(item.clientName)
    const [date, setDate] = useState(item.paymentDue)
    const [amount, setAmount] = useState(item.total)
